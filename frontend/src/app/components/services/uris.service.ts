...
export class URIService {
    ...
    private readonly URIs = {
        ...
        testsLocal: 'http://ec2-18-206-188-225.compute-1.amazonaws.com/api/project2/tests'
    };
    ...
    getURIRoute(uri: string): string {
        if (!this.URIs.hasOwnProperty(uri)) {
            throw new Error(`Invalid URI: must only be ${Object.keys(this.URIs)
